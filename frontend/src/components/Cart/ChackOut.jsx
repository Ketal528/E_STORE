...
function ChackOut() {
  ...
  // Ensure cart is loaded before proceesing
  useEffect(() => {
  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 max-w-7xl mx-auto py-10 px-6 tracking-tighter">
      ...
      <div className="bg-white rounded-lg p-6">
        <h2 className="text-2xl uppercase mb-6">Chackout</h2>
        <form onSubmit={handleCreateCheckout}>
          ...
          <div className="mb-4">
            <label className="block text-gray-700">Contry</label>
            <input
              type="text"
              value={shippingAddress.contry}
              onChange={(e) =>
                setShippingAddres({
                  ...shippingAddress,
